/*
 * PROJECT P03: Arduino Color Sorter + Robotic Arm
 * STATUS: [VERIFIED]
 * 
 * Historical source code extracted from verified project archives.
 * Cleaned and standardized for the engineering portfolio.
 * 
 * Hardware mapped:
 * - TCS3200 Color Sensor: S0 (D4), S1 (D5), S2 (D6), S3 (D7), Out (D8)
 * - 5 Micro Servos: D9, D10, D11, D12, D13
 * - Indicator LEDs: Red (A0), Yellow (A1), Blue (A2)
 */
...
void checkColor() {
  ...
  // Detect Yellow/Green (Custom calibrated thresholds)
...
void moveBlock() {
  ...
  // Reverse sequence to return arm
